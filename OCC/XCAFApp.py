...
Handle_XCAFApp_Application._get_reference = new_instancemethod(_XCAFApp.Handle_XCAFApp_Application__get_reference, None, Handle_XCAFApp_Application)
...
def Handle_XCAFApp_Application_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_XCAFApp_Application const":
