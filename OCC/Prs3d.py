...
Handle_Prs3d_BasicAspect._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_BasicAspect__get_reference, None, Handle_Prs3d_BasicAspect)
...
def Handle_Prs3d_BasicAspect_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_BasicAspect const":
...
Prs3d_Drawer.SetVertexDrawMode = new_instancemethod(_Prs3d.Prs3d_Drawer_SetVertexDrawMode, None, Prs3d_Drawer)
Prs3d_Drawer.VertexDrawMode = new_instancemethod(_Prs3d.Prs3d_Drawer_VertexDrawMode, None, Prs3d_Drawer)
...
Handle_Prs3d_Drawer._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_Drawer__get_reference, None, Handle_Prs3d_Drawer)
...
def Handle_Prs3d_Drawer_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_Drawer const":
...
Handle_Prs3d_PlaneSet._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_PlaneSet__get_reference, None, Handle_Prs3d_PlaneSet)
...
def Handle_Prs3d_PlaneSet_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_PlaneSet const":
...
class Prs3d_Presentation(OCC.Graphic3d.Graphic3d_Structure):
    ...
    def SetIsForHighlight(self, *args) -> "void":
        ...
        * marks the structure <self> representing wired structure needed for highlight only so it won't be added to BVH tree.
        ...
        """
        return _Prs3d.Prs3d_Presentation_SetIsForHighlight(self, *args)
...
Prs3d_Presentation.SetIsForHighlight = new_instancemethod(_Prs3d.Prs3d_Presentation_SetIsForHighlight, None, Prs3d_Presentation)
...
Handle_Prs3d_Presentation._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_Presentation__get_reference, None, Handle_Prs3d_Presentation)
...
def Handle_Prs3d_Presentation_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_Presentation const":
...
Handle_Prs3d_Projector._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_Projector__get_reference, None, Handle_Prs3d_Projector)
...
def Handle_Prs3d_Projector_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_Projector const":
...
Handle_Prs3d_ArrowAspect._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_ArrowAspect__get_reference, None, Handle_Prs3d_ArrowAspect)
...
def Handle_Prs3d_ArrowAspect_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_ArrowAspect const":
...
Handle_Prs3d_DatumAspect._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_DatumAspect__get_reference, None, Handle_Prs3d_DatumAspect)
...
def Handle_Prs3d_DatumAspect_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_DatumAspect const":
...
Handle_Prs3d_DimensionAspect._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_DimensionAspect__get_reference, None, Handle_Prs3d_DimensionAspect)
...
def Handle_Prs3d_DimensionAspect_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_DimensionAspect const":
...
Handle_Prs3d_LineAspect._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_LineAspect__get_reference, None, Handle_Prs3d_LineAspect)
...
def Handle_Prs3d_LineAspect_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_LineAspect const":
...
Handle_Prs3d_PlaneAspect._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_PlaneAspect__get_reference, None, Handle_Prs3d_PlaneAspect)
...
def Handle_Prs3d_PlaneAspect_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_PlaneAspect const":
...
Handle_Prs3d_PointAspect._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_PointAspect__get_reference, None, Handle_Prs3d_PointAspect)
...
def Handle_Prs3d_PointAspect_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_PointAspect const":
...
class Handle_Prs3d_PresentationShadow(Handle_Prs3d_Presentation):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, *args):
        _Prs3d.Handle_Prs3d_PresentationShadow_swiginit(self, _Prs3d.new_Handle_Prs3d_PresentationShadow(*args))
...
Handle_Prs3d_PresentationShadow.Nullify = new_instancemethod(_Prs3d.Handle_Prs3d_PresentationShadow_Nullify, None, Handle_Prs3d_PresentationShadow)
Handle_Prs3d_PresentationShadow.IsNull = new_instancemethod(_Prs3d.Handle_Prs3d_PresentationShadow_IsNull, None, Handle_Prs3d_PresentationShadow)
Handle_Prs3d_PresentationShadow._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_PresentationShadow__get_reference, None, Handle_Prs3d_PresentationShadow)
...
def Handle_Prs3d_PresentationShadow_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_PresentationShadow const":
    return _Prs3d.Handle_Prs3d_PresentationShadow_DownCast(AnObject)
...
Handle_Prs3d_ShadingAspect._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_ShadingAspect__get_reference, None, Handle_Prs3d_ShadingAspect)
...
def Handle_Prs3d_ShadingAspect_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_ShadingAspect const":
...
Handle_Prs3d_TextAspect._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_TextAspect__get_reference, None, Handle_Prs3d_TextAspect)
...
def Handle_Prs3d_TextAspect_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_TextAspect const":
...
Handle_Prs3d_IsoAspect._get_reference = new_instancemethod(_Prs3d.Handle_Prs3d_IsoAspect__get_reference, None, Handle_Prs3d_IsoAspect)
...
def Handle_Prs3d_IsoAspect_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Prs3d_IsoAspect const":
