...
class Blend_AppFunction(OCC.math.math_FunctionSetWithDerivatives):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
...
class Blend_CurvPointFuncInv(OCC.math.math_FunctionSetWithDerivatives):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
...
class Blend_FuncInv(OCC.math.math_FunctionSetWithDerivatives):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
...
Handle_Blend_SequenceNodeOfSequenceOfPoint._get_reference = new_instancemethod(_Blend.Handle_Blend_SequenceNodeOfSequenceOfPoint__get_reference, None, Handle_Blend_SequenceNodeOfSequenceOfPoint)
...
def Handle_Blend_SequenceNodeOfSequenceOfPoint_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Blend_SequenceNodeOfSequenceOfPoint const":
...
class Blend_SurfCurvFuncInv(OCC.math.math_FunctionSetWithDerivatives):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
...
class Blend_SurfPointFuncInv(OCC.math.math_FunctionSetWithDerivatives):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
