...
class ProjLib_CompProjectedCurve(OCC.Adaptor2d.Adaptor2d_Curve2d):
    ...
    def GetSequence(self, *args) -> "Handle_ProjLib_HSequenceOfHSequenceOfPnt":
        """
...
Handle_ProjLib_HCompProjectedCurve._get_reference = new_instancemethod(_ProjLib.Handle_ProjLib_HCompProjectedCurve__get_reference, None, Handle_ProjLib_HCompProjectedCurve)
...
def Handle_ProjLib_HCompProjectedCurve_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_ProjLib_HCompProjectedCurve const":
...
Handle_ProjLib_HProjectedCurve._get_reference = new_instancemethod(_ProjLib.Handle_ProjLib_HProjectedCurve__get_reference, None, Handle_ProjLib_HProjectedCurve)
...
def Handle_ProjLib_HProjectedCurve_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_ProjLib_HProjectedCurve const":
...
Handle_ProjLib_HSequenceOfHSequenceOfPnt._get_reference = new_instancemethod(_ProjLib.Handle_ProjLib_HSequenceOfHSequenceOfPnt__get_reference, None, Handle_ProjLib_HSequenceOfHSequenceOfPnt)
...
def Handle_ProjLib_HSequenceOfHSequenceOfPnt_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_ProjLib_HSequenceOfHSequenceOfPnt const":
...
class ProjLib_PrjFunc(OCC.math.math_FunctionSetWithDerivatives):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
Handle_ProjLib_SequenceNodeOfSequenceOfHSequenceOfPnt._get_reference = new_instancemethod(_ProjLib.Handle_ProjLib_SequenceNodeOfSequenceOfHSequenceOfPnt__get_reference, None, Handle_ProjLib_SequenceNodeOfSequenceOfHSequenceOfPnt)
...
def Handle_ProjLib_SequenceNodeOfSequenceOfHSequenceOfPnt_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_ProjLib_SequenceNodeOfSequenceOfHSequenceOfPnt const":
...
class ProjLib_SequenceOfHSequenceOfPnt(OCC.TCollection.TCollection_BaseSequence):
    ...
    def First(self, *args) -> "Handle_TColgp_HSequenceOfPnt":
        """
        :rtype: Handle_TColgp_HSequenceOfPnt
    ...
    def Last(self, *args) -> "Handle_TColgp_HSequenceOfPnt":
        """
        :rtype: Handle_TColgp_HSequenceOfPnt
