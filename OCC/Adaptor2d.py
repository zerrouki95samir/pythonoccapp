...
Handle_Adaptor2d_HCurve2d._get_reference = new_instancemethod(_Adaptor2d.Handle_Adaptor2d_HCurve2d__get_reference, None, Handle_Adaptor2d_HCurve2d)
...
def Handle_Adaptor2d_HCurve2d_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Adaptor2d_HCurve2d const":
...
Handle_Adaptor2d_HLine2d._get_reference = new_instancemethod(_Adaptor2d.Handle_Adaptor2d_HLine2d__get_reference, None, Handle_Adaptor2d_HLine2d)
...
def Handle_Adaptor2d_HLine2d_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Adaptor2d_HLine2d const":
