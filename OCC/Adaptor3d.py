...
Handle_Adaptor3d_HCurve._get_reference = new_instancemethod(_Adaptor3d.Handle_Adaptor3d_HCurve__get_reference, None, Handle_Adaptor3d_HCurve)
...
def Handle_Adaptor3d_HCurve_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Adaptor3d_HCurve const":
...
Handle_Adaptor3d_HOffsetCurve._get_reference = new_instancemethod(_Adaptor3d.Handle_Adaptor3d_HOffsetCurve__get_reference, None, Handle_Adaptor3d_HOffsetCurve)
...
def Handle_Adaptor3d_HOffsetCurve_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Adaptor3d_HOffsetCurve const":
...
Handle_Adaptor3d_HSurface._get_reference = new_instancemethod(_Adaptor3d.Handle_Adaptor3d_HSurface__get_reference, None, Handle_Adaptor3d_HSurface)
...
def Handle_Adaptor3d_HSurface_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Adaptor3d_HSurface const":
...
Handle_Adaptor3d_HVertex._get_reference = new_instancemethod(_Adaptor3d.Handle_Adaptor3d_HVertex__get_reference, None, Handle_Adaptor3d_HVertex)
...
def Handle_Adaptor3d_HVertex_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Adaptor3d_HVertex const":
...
class Adaptor3d_InterFunc(OCC.math.math_FunctionWithDerivative):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
Handle_Adaptor3d_TopolTool._get_reference = new_instancemethod(_Adaptor3d.Handle_Adaptor3d_TopolTool__get_reference, None, Handle_Adaptor3d_TopolTool)
...
def Handle_Adaptor3d_TopolTool_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Adaptor3d_TopolTool const":
...
Handle_Adaptor3d_HCurveOnSurface._get_reference = new_instancemethod(_Adaptor3d.Handle_Adaptor3d_HCurveOnSurface__get_reference, None, Handle_Adaptor3d_HCurveOnSurface)
...
def Handle_Adaptor3d_HCurveOnSurface_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Adaptor3d_HCurveOnSurface const":
...
Handle_Adaptor3d_HIsoCurve._get_reference = new_instancemethod(_Adaptor3d.Handle_Adaptor3d_HIsoCurve__get_reference, None, Handle_Adaptor3d_HIsoCurve)
...
def Handle_Adaptor3d_HIsoCurve_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Adaptor3d_HIsoCurve const":
...
Handle_Adaptor3d_HSurfaceOfLinearExtrusion._get_reference = new_instancemethod(_Adaptor3d.Handle_Adaptor3d_HSurfaceOfLinearExtrusion__get_reference, None, Handle_Adaptor3d_HSurfaceOfLinearExtrusion)
...
def Handle_Adaptor3d_HSurfaceOfLinearExtrusion_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Adaptor3d_HSurfaceOfLinearExtrusion const":
...
Handle_Adaptor3d_HSurfaceOfRevolution._get_reference = new_instancemethod(_Adaptor3d.Handle_Adaptor3d_HSurfaceOfRevolution__get_reference, None, Handle_Adaptor3d_HSurfaceOfRevolution)
...
def Handle_Adaptor3d_HSurfaceOfRevolution_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Adaptor3d_HSurfaceOfRevolution const":
