...
Handle_Poly_HArray1OfTriangle._get_reference = new_instancemethod(_Poly.Handle_Poly_HArray1OfTriangle__get_reference, None, Handle_Poly_HArray1OfTriangle)
...
def Handle_Poly_HArray1OfTriangle_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Poly_HArray1OfTriangle const":
...
Handle_Poly_Polygon2D._get_reference = new_instancemethod(_Poly.Handle_Poly_Polygon2D__get_reference, None, Handle_Poly_Polygon2D)
...
def Handle_Poly_Polygon2D_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Poly_Polygon2D const":
...
Handle_Poly_Polygon3D._get_reference = new_instancemethod(_Poly.Handle_Poly_Polygon3D__get_reference, None, Handle_Poly_Polygon3D)
...
def Handle_Poly_Polygon3D_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Poly_Polygon3D const":
...
Handle_Poly_PolygonOnTriangulation._get_reference = new_instancemethod(_Poly.Handle_Poly_PolygonOnTriangulation__get_reference, None, Handle_Poly_PolygonOnTriangulation)
...
def Handle_Poly_PolygonOnTriangulation_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Poly_PolygonOnTriangulation const":
...
Handle_Poly_Triangulation._get_reference = new_instancemethod(_Poly.Handle_Poly_Triangulation__get_reference, None, Handle_Poly_Triangulation)
...
def Handle_Poly_Triangulation_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Poly_Triangulation const":
