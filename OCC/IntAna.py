...
Handle_IntAna_ListNodeOfListOfCurve._get_reference = new_instancemethod(_IntAna.Handle_IntAna_ListNodeOfListOfCurve__get_reference, None, Handle_IntAna_ListNodeOfListOfCurve)
...
def Handle_IntAna_ListNodeOfListOfCurve_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_IntAna_ListNodeOfListOfCurve const":
