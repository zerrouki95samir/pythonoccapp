...
Handle_Quantity_HArray1OfColor._get_reference = new_instancemethod(_Quantity.Handle_Quantity_HArray1OfColor__get_reference, None, Handle_Quantity_HArray1OfColor)
...
def Handle_Quantity_HArray1OfColor_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Quantity_HArray1OfColor const":
