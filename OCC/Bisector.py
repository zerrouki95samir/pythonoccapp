...
class Bisector_Bisec(object):
    ...
    def Value(self, *args) -> "Handle_Geom2d_TrimmedCurve":
        """
    ...
    def ChangeValue(self, *args) -> "Handle_Geom2d_TrimmedCurve":
        """
        * Returns the Curve of <self>.
...
Handle_Bisector_Curve._get_reference = new_instancemethod(_Bisector.Handle_Bisector_Curve__get_reference, None, Handle_Bisector_Curve)
...
def Handle_Bisector_Curve_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Bisector_Curve const":
...
class Bisector_FunctionH(OCC.math.math_FunctionWithDerivative):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
class Bisector_FunctionInter(OCC.math.math_FunctionWithDerivative):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
Handle_Bisector_BisecAna._get_reference = new_instancemethod(_Bisector.Handle_Bisector_BisecAna__get_reference, None, Handle_Bisector_BisecAna)
...
def Handle_Bisector_BisecAna_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Bisector_BisecAna const":
...
Handle_Bisector_BisecCC._get_reference = new_instancemethod(_Bisector.Handle_Bisector_BisecCC__get_reference, None, Handle_Bisector_BisecCC)
...
def Handle_Bisector_BisecCC_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Bisector_BisecCC const":
...
Handle_Bisector_BisecPC._get_reference = new_instancemethod(_Bisector.Handle_Bisector_BisecPC__get_reference, None, Handle_Bisector_BisecPC)
...
def Handle_Bisector_BisecPC_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Bisector_BisecPC const":
