...
class gp_XY(object):
    ...
    def ChangeCoord(self, *args) -> "Standard_Real &":
        """
        :param theIndex:
        :type theIndex: int
        :rtype: float
...
gp_XY.ChangeCoord = new_instancemethod(_gp.gp_XY_ChangeCoord, None, gp_XY)
...
gp_XYZ.ChangeCoord = new_instancemethod(_gp.gp_XYZ_ChangeCoord, None, gp_XYZ)
