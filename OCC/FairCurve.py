...
class FairCurve_BattenLaw(OCC.math.math_Function):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
class FairCurve_DistributionOfEnergy(OCC.math.math_FunctionSet):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
...
class FairCurve_Energy(OCC.math.math_MultipleVarFunctionWithHessian):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    ...
    def Poles(self, *args) -> "Handle_TColgp_HArray1OfPnt2d":
        """
        * return the poles
...
class FairCurve_Newton(OCC.math.math_NewtonMinimum):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
