...
Handle_BRepClass3d_DataMapNodeOfMapOfInter._get_reference = new_instancemethod(_BRepClass3d.Handle_BRepClass3d_DataMapNodeOfMapOfInter__get_reference, None, Handle_BRepClass3d_DataMapNodeOfMapOfInter)
...
def Handle_BRepClass3d_DataMapNodeOfMapOfInter_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_BRepClass3d_DataMapNodeOfMapOfInter const":
