...
Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt._get_reference = new_instancemethod(_IntCurveSurface.Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt__get_reference, None, Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt)
...
def Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_IntCurveSurface_SequenceNodeOfSequenceOfPnt const":
...
Handle_IntCurveSurface_SequenceNodeOfSequenceOfSeg._get_reference = new_instancemethod(_IntCurveSurface.Handle_IntCurveSurface_SequenceNodeOfSequenceOfSeg__get_reference, None, Handle_IntCurveSurface_SequenceNodeOfSequenceOfSeg)
...
def Handle_IntCurveSurface_SequenceNodeOfSequenceOfSeg_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_IntCurveSurface_SequenceNodeOfSequenceOfSeg const":
...
class IntCurveSurface_TheCSFunctionOfHInter(OCC.math.math_FunctionSetWithDerivatives):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ...
    def AuxillarCurve(self, *args) -> "Handle_Adaptor3d_HCurve":
        """
...
class IntCurveSurface_TheQuadCurvFuncOfTheQuadCurvExactHInter(OCC.math.math_FunctionWithDerivative):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
