...
Handle_PLib_Base._get_reference = new_instancemethod(_PLib.Handle_PLib_Base__get_reference, None, Handle_PLib_Base)
Handle_PLib_Base_swigregister = _PLib.Handle_PLib_Base_swigregister
Handle_PLib_Base_swigregister(Handle_PLib_Base)

def Handle_PLib_Base_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_PLib_Base const":
...
class Handle_PLib_HermitJacobi(Handle_PLib_Base):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, *args):
        _PLib.Handle_PLib_HermitJacobi_swiginit(self, _PLib.new_Handle_PLib_HermitJacobi(*args))
...
Handle_PLib_HermitJacobi.Nullify = new_instancemethod(_PLib.Handle_PLib_HermitJacobi_Nullify, None, Handle_PLib_HermitJacobi)
Handle_PLib_HermitJacobi.IsNull = new_instancemethod(_PLib.Handle_PLib_HermitJacobi_IsNull, None, Handle_PLib_HermitJacobi)
Handle_PLib_HermitJacobi._get_reference = new_instancemethod(_PLib.Handle_PLib_HermitJacobi__get_reference, None, Handle_PLib_HermitJacobi)
...
def Handle_PLib_HermitJacobi_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_PLib_HermitJacobi const":
    return _PLib.Handle_PLib_HermitJacobi_DownCast(AnObject)
...
Handle_PLib_JacobiPolynomial._get_reference = new_instancemethod(_PLib.Handle_PLib_JacobiPolynomial__get_reference, None, Handle_PLib_JacobiPolynomial)
...
def Handle_PLib_JacobiPolynomial_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_PLib_JacobiPolynomial const":
