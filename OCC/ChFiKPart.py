...
Handle_ChFiKPart_DataMapNodeOfRstMap._get_reference = new_instancemethod(_ChFiKPart.Handle_ChFiKPart_DataMapNodeOfRstMap__get_reference, None, Handle_ChFiKPart_DataMapNodeOfRstMap)
...
def Handle_ChFiKPart_DataMapNodeOfRstMap_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_ChFiKPart_DataMapNodeOfRstMap const":
...
class ChFiKPart_RstMap(OCC.TCollection.TCollection_BasicMap):
    ...
    def Find(self, *args) -> "Handle_Adaptor2d_HCurve2d":
        """
        :param K:
        :type K: int &
        :rtype: Handle_Adaptor2d_HCurve2d
