...
Handle_AppStd_Application._get_reference = new_instancemethod(_AppStd.Handle_AppStd_Application__get_reference, None, Handle_AppStd_Application)
...
def Handle_AppStd_Application_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_AppStd_Application const":
