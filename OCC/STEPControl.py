...
Handle_STEPControl_ActorRead._get_reference = new_instancemethod(_STEPControl.Handle_STEPControl_ActorRead__get_reference, None, Handle_STEPControl_ActorRead)
...
def Handle_STEPControl_ActorRead_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_STEPControl_ActorRead const":
...
Handle_STEPControl_ActorWrite._get_reference = new_instancemethod(_STEPControl.Handle_STEPControl_ActorWrite__get_reference, None, Handle_STEPControl_ActorWrite)
...
def Handle_STEPControl_ActorWrite_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_STEPControl_ActorWrite const":
...
Handle_STEPControl_Controller._get_reference = new_instancemethod(_STEPControl.Handle_STEPControl_Controller__get_reference, None, Handle_STEPControl_Controller)
...
def Handle_STEPControl_Controller_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_STEPControl_Controller const":
