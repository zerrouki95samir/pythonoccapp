...
Handle_IntSurf_LineOn2S._get_reference = new_instancemethod(_IntSurf.Handle_IntSurf_LineOn2S__get_reference, None, Handle_IntSurf_LineOn2S)
...
def Handle_IntSurf_LineOn2S_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_IntSurf_LineOn2S const":
...
Handle_IntSurf_ListNodeOfListOfPntOn2S._get_reference = new_instancemethod(_IntSurf.Handle_IntSurf_ListNodeOfListOfPntOn2S__get_reference, None, Handle_IntSurf_ListNodeOfListOfPntOn2S)
...
def Handle_IntSurf_ListNodeOfListOfPntOn2S_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_IntSurf_ListNodeOfListOfPntOn2S const":
...
Handle_IntSurf_SequenceNodeOfSequenceOfCouple._get_reference = new_instancemethod(_IntSurf.Handle_IntSurf_SequenceNodeOfSequenceOfCouple__get_reference, None, Handle_IntSurf_SequenceNodeOfSequenceOfCouple)
...
def Handle_IntSurf_SequenceNodeOfSequenceOfCouple_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_IntSurf_SequenceNodeOfSequenceOfCouple const":
...
Handle_IntSurf_SequenceNodeOfSequenceOfInteriorPoint._get_reference = new_instancemethod(_IntSurf.Handle_IntSurf_SequenceNodeOfSequenceOfInteriorPoint__get_reference, None, Handle_IntSurf_SequenceNodeOfSequenceOfInteriorPoint)
...
def Handle_IntSurf_SequenceNodeOfSequenceOfInteriorPoint_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_IntSurf_SequenceNodeOfSequenceOfInteriorPoint const":
...
Handle_IntSurf_SequenceNodeOfSequenceOfPathPoint._get_reference = new_instancemethod(_IntSurf.Handle_IntSurf_SequenceNodeOfSequenceOfPathPoint__get_reference, None, Handle_IntSurf_SequenceNodeOfSequenceOfPathPoint)
...
def Handle_IntSurf_SequenceNodeOfSequenceOfPathPoint_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_IntSurf_SequenceNodeOfSequenceOfPathPoint const":
