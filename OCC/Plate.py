...
Handle_Plate_HArray1OfPinpointConstraint._get_reference = new_instancemethod(_Plate.Handle_Plate_HArray1OfPinpointConstraint__get_reference, None, Handle_Plate_HArray1OfPinpointConstraint)
...
def Handle_Plate_HArray1OfPinpointConstraint_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Plate_HArray1OfPinpointConstraint const":
...
Handle_Plate_SequenceNodeOfSequenceOfLinearScalarConstraint._get_reference = new_instancemethod(_Plate.Handle_Plate_SequenceNodeOfSequenceOfLinearScalarConstraint__get_reference, None, Handle_Plate_SequenceNodeOfSequenceOfLinearScalarConstraint)
...
def Handle_Plate_SequenceNodeOfSequenceOfLinearScalarConstraint_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Plate_SequenceNodeOfSequenceOfLinearScalarConstraint const":
...
Handle_Plate_SequenceNodeOfSequenceOfLinearXYZConstraint._get_reference = new_instancemethod(_Plate.Handle_Plate_SequenceNodeOfSequenceOfLinearXYZConstraint__get_reference, None, Handle_Plate_SequenceNodeOfSequenceOfLinearXYZConstraint)
...
def Handle_Plate_SequenceNodeOfSequenceOfLinearXYZConstraint_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Plate_SequenceNodeOfSequenceOfLinearXYZConstraint const":
...
Handle_Plate_SequenceNodeOfSequenceOfPinpointConstraint._get_reference = new_instancemethod(_Plate.Handle_Plate_SequenceNodeOfSequenceOfPinpointConstraint__get_reference, None, Handle_Plate_SequenceNodeOfSequenceOfPinpointConstraint)
...
def Handle_Plate_SequenceNodeOfSequenceOfPinpointConstraint_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_Plate_SequenceNodeOfSequenceOfPinpointConstraint const":
