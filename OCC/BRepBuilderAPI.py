...
class BRepBuilderAPI_Sewing(OCC.MMgt.MMgt_TShared):
    ...
    def GetContext(self, *args) -> "Handle_BRepTools_ReShape":
        """
        * return context
...
Handle_BRepBuilderAPI_Sewing._get_reference = new_instancemethod(_BRepBuilderAPI.Handle_BRepBuilderAPI_Sewing__get_reference, None, Handle_BRepBuilderAPI_Sewing)
...
def Handle_BRepBuilderAPI_Sewing_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_BRepBuilderAPI_Sewing const":
