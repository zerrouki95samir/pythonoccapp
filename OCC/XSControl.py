...
Handle_XSControl_ConnectedShapes._get_reference = new_instancemethod(_XSControl.Handle_XSControl_ConnectedShapes__get_reference, None, Handle_XSControl_ConnectedShapes)
...
def Handle_XSControl_ConnectedShapes_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_XSControl_ConnectedShapes const":
...
class XSControl_Controller(OCC.MMgt.MMgt_TShared):
    ...
    def ListRecorded(*args) -> "Handle_TColStd_HSequenceOfHAsciiString":
        """
        * Returns the list of names of recorded norms, according to mode = 0 (D) : all the recorded names < 0 : for each distinct norm, its resource (short) name > 0 : for each distinct norm, its complete (long) name
        ...
        """
        return _XSControl.XSControl_Controller_ListRecorded(*args)
    ...
    def Profile(self, *args) -> "Handle_IFSelect_Profile":
        """
        * Returns the Profile It starts with a first configuration Base (empty) and the following options : protocol for the Protocol sign-type for the SignType (Default Signature for Type) access for the WorkLibrary tr-read for ActorRead (import processor) tr-write for ActorWrite (export processor)
        ...
        """
        return _XSControl.XSControl_Controller_Profile(self, *args)
    ...
    def SignType(self, *args) -> "Handle_IFSelect_Signature":
        ...
        * Returns the SignType attached to the norm (from field)
        ...
        """
        return _XSControl.XSControl_Controller_SignType(self, *args)
    ...
    def ActorWrite(self, *args) -> "Handle_Transfer_ActorOfFinderProcess":
        """
    ...
    def AdaptorSession(self, *args) -> "Handle_Dico_DictionaryOfTransient":
        """
...
def XSControl_Controller_ListRecorded(*args) -> "Handle_TColStd_HSequenceOfHAsciiString":
    """
    * Returns the list of names of recorded norms, according to mode = 0 (D) : all the recorded names < 0 : for each distinct norm, its resource (short) name > 0 : for each distinct norm, its complete (long) name
...
Handle_XSControl_Controller._get_reference = new_instancemethod(_XSControl.Handle_XSControl_Controller__get_reference, None, Handle_XSControl_Controller)
...
def Handle_XSControl_Controller_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_XSControl_Controller const":
...
class XSControl_Reader(object):
    ...
    def RootForTransfer(self, *args) -> "Handle_Standard_Transient":
        """
...
class XSControl_SelectForTransfer(OCC.IFSelect.IFSelect_SelectExtract):
    ...
    def Actor(self, *args) -> "Handle_Transfer_ActorOfTransientProcess":
        """
    ...
    def Reader(self, *args) -> "Handle_XSControl_TransferReader":
        """
...
Handle_XSControl_SelectForTransfer._get_reference = new_instancemethod(_XSControl.Handle_XSControl_SelectForTransfer__get_reference, None, Handle_XSControl_SelectForTransfer)
...
def Handle_XSControl_SelectForTransfer_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_XSControl_SelectForTransfer const":
...
class XSControl_SignTransferStatus(OCC.IFSelect.IFSelect_Signature):
    ...
    def Map(self, *args) -> "Handle_Transfer_TransientProcess":
        """
...
Handle_XSControl_SignTransferStatus._get_reference = new_instancemethod(_XSControl.Handle_XSControl_SignTransferStatus__get_reference, None, Handle_XSControl_SignTransferStatus)
...
def Handle_XSControl_SignTransferStatus_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_XSControl_SignTransferStatus const":
...
class XSControl_TransferReader(OCC.MMgt.MMgt_TShared):
    ...
    def Context(self, *args) -> "Handle_Dico_DictionaryOfTransient":
        """
    ...
    def RecordedList(self, *args) -> "Handle_TColStd_HSequenceOfTransient":
        """
...
Handle_XSControl_TransferReader._get_reference = new_instancemethod(_XSControl.Handle_XSControl_TransferReader__get_reference, None, Handle_XSControl_TransferReader)
...
def Handle_XSControl_TransferReader_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_XSControl_TransferReader const":
...
class XSControl_TransferWriter(OCC.MMgt.MMgt_TShared):
    ...
    def Controller(self, *args) -> "Handle_XSControl_Controller":
        """
...
Handle_XSControl_TransferWriter._get_reference = new_instancemethod(_XSControl.Handle_XSControl_TransferWriter__get_reference, None, Handle_XSControl_TransferWriter)
...
def Handle_XSControl_TransferWriter_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_XSControl_TransferWriter const":
...
class XSControl_Utils(object):
    ...
    def NewSeqTra(self, *args) -> "Handle_TColStd_HSequenceOfTransient":
        """
        :rtype: Handle_TColStd_HSequenceOfTransient
    ...
    def NewSeqCStr(self, *args) -> "Handle_TColStd_HSequenceOfHAsciiString":
        """
        :rtype: Handle_TColStd_HSequenceOfHAsciiString
    ...
    def NewSeqEStr(self, *args) -> "Handle_TColStd_HSequenceOfHExtendedString":
        """
    ...
    def NewShape(self, *args) -> "TopoDS_Shape":
        """
        * Returns a new empty, undefined Shape, which can then be filled by ReadShape
        ...
        """
        return _XSControl.XSControl_Utils_NewShape(self, *args)
    ...
    def NewSeqShape(self, *args) -> "Handle_TopTools_HSequenceOfShape":
        """
        :rtype: Handle_TopTools_HSequenceOfShape
...
class XSControl_WorkSession(OCC.IFSelect.IFSelect_WorkSession):
    ...
    def AdaptNorm(self, *args) -> "void":
        ...
        * This method is called once a new norm has been successfully selected. It can be redefined, default does nothing
        ...
        """
        return _XSControl.XSControl_WorkSession_AdaptNorm(self, *args)
    ...
    def NormAdaptor(self, *args) -> "Handle_XSControl_Controller":
        """
    ...
    def TransferReader(self, *args) -> "Handle_XSControl_TransferReader":
        """
    ...
    def MapReader(self, *args) -> "Handle_Transfer_TransientProcess":
        """
    ...
    def TransferWriter(self, *args) -> "Handle_XSControl_TransferWriter":
        """
        * Returns the Transfer Reader, Null if not set
    ...
    def MapWriter(self, *args) -> "Handle_Transfer_FinderProcess":
        """
        * Returns the FinderProcess (internal data for TransferWriter)
        ...
        """
        return _XSControl.XSControl_WorkSession_MapWriter(self, *args)
    ...
    def ModeWriteShape(self, *args) -> "Standard_Integer":
        """
        * Records the current Mode to Write Shapes
        ...
        """
        return _XSControl.XSControl_WorkSession_ModeWriteShape(self, *args)
    ...
    def Vars(self, *args) -> "Handle_XSControl_Vars":
        """
        :rtype: Handle_XSControl_Vars
    ...
    def ClearBinders(self, *args) -> "void":
        """
        * Clears binders
        ...
        """
        return _XSControl.XSControl_WorkSession_ClearBinders(self, *args)
    ...
    def Destroy(self, *args) -> "void":
        ...
        """
        return _XSControl.XSControl_WorkSession_Destroy(self, *args)
...
Handle_XSControl_WorkSession._get_reference = new_instancemethod(_XSControl.Handle_XSControl_WorkSession__get_reference, None, Handle_XSControl_WorkSession)
...
def Handle_XSControl_WorkSession_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_XSControl_WorkSession const":
