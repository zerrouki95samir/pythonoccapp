...
Handle_ShapeBuild_ReShape._get_reference = new_instancemethod(_ShapeBuild.Handle_ShapeBuild_ReShape__get_reference, None, Handle_ShapeBuild_ReShape)
...
def Handle_ShapeBuild_ReShape_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_ShapeBuild_ReShape const":
