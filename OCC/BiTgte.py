...
Handle_BiTgte_DataMapNodeOfDataMapOfShapeBox._get_reference = new_instancemethod(_BiTgte.Handle_BiTgte_DataMapNodeOfDataMapOfShapeBox__get_reference, None, Handle_BiTgte_DataMapNodeOfDataMapOfShapeBox)
...
def Handle_BiTgte_DataMapNodeOfDataMapOfShapeBox_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_BiTgte_DataMapNodeOfDataMapOfShapeBox const":
...
Handle_BiTgte_HCurveOnEdge._get_reference = new_instancemethod(_BiTgte.Handle_BiTgte_HCurveOnEdge__get_reference, None, Handle_BiTgte_HCurveOnEdge)
...
def Handle_BiTgte_HCurveOnEdge_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_BiTgte_HCurveOnEdge const":
...
Handle_BiTgte_HCurveOnVertex._get_reference = new_instancemethod(_BiTgte.Handle_BiTgte_HCurveOnVertex__get_reference, None, Handle_BiTgte_HCurveOnVertex)
...
def Handle_BiTgte_HCurveOnVertex_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_BiTgte_HCurveOnVertex const":
