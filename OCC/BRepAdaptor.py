...
Handle_BRepAdaptor_HArray1OfCurve._get_reference = new_instancemethod(_BRepAdaptor.Handle_BRepAdaptor_HArray1OfCurve__get_reference, None, Handle_BRepAdaptor_HArray1OfCurve)
...
def Handle_BRepAdaptor_HArray1OfCurve_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_BRepAdaptor_HArray1OfCurve const":
...
Handle_BRepAdaptor_HCompCurve._get_reference = new_instancemethod(_BRepAdaptor.Handle_BRepAdaptor_HCompCurve__get_reference, None, Handle_BRepAdaptor_HCompCurve)
...
def Handle_BRepAdaptor_HCompCurve_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_BRepAdaptor_HCompCurve const":
...
Handle_BRepAdaptor_HCurve._get_reference = new_instancemethod(_BRepAdaptor.Handle_BRepAdaptor_HCurve__get_reference, None, Handle_BRepAdaptor_HCurve)
...
def Handle_BRepAdaptor_HCurve_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_BRepAdaptor_HCurve const":
...
Handle_BRepAdaptor_HCurve2d._get_reference = new_instancemethod(_BRepAdaptor.Handle_BRepAdaptor_HCurve2d__get_reference, None, Handle_BRepAdaptor_HCurve2d)
...
def Handle_BRepAdaptor_HCurve2d_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_BRepAdaptor_HCurve2d const":
...
Handle_BRepAdaptor_HSurface._get_reference = new_instancemethod(_BRepAdaptor.Handle_BRepAdaptor_HSurface__get_reference, None, Handle_BRepAdaptor_HSurface)
...
def Handle_BRepAdaptor_HSurface_DownCast(AnObject: 'Handle_Standard_Transient') -> "Handle_BRepAdaptor_HSurface const":
